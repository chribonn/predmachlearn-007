...
The first 6 columns of the data consists of data that will not contribute to the analysis. These have been removed.
...
The model returned a 99.7% pedicition accuracy and a 99.6% Kappa coefficient. This seems to indicate that the model is adequate for prediction purposes.
...
### Conclusions
The result shown above indicates that it is possible to predict how well a person is preforming an excercise using the sensors available.  